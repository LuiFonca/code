...
# Bitfield de flags (offset 0x8E, uint16).
...
class TelemetryFrame:
    ...
    def from_bytes(d: bytes) -> "TelemetryFrame":
        ...
        suspension_fl, suspension_fr, suspension_rl, suspension_rr = struct.unpack("<ffff", d[0x98:0xA8])
        tire_slip_fl, tire_slip_fr, tire_slip_rl, tire_slip_rr = struct.unpack("<ffff", d[0xE4:0xF4])
