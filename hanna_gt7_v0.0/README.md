...
sem duplicação — e é o que torna 697 testes possíveis, já que nenhum deles
...
gt7voice/         Rádio falado
  ...
  system.py    say / SAPI / espeak-ng      tests/    697 testes
...
python3 -m pytest              # 697 testes, ~2min15
